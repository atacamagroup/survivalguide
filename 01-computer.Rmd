...
If you do not already have one, set up a [GitHub account](https://github.com).
Make sure that you get the [education discount](https://education.github.com/)
so you can set up private repos, plus some other goodies.

![](http://imgs.xkcd.com/comics/git.png)

## R Programming

If you don't already have it, download [`R`](https://cran.r-project.org) and, if
you'd like, [RStudio](https://www.rstudio.com/products/rstudio/#Desktop).
